...
\begin{definition}
    An \defstyle{$n$-tableau} is a standard tableau whose entries are precisely the numbers $\{1,\ldots,n\}$.
...
\begin{definition}
    We say that two tableaux $S,T \in \SYT(n)$ of the same shape are \defstyle{row equivalent} if $S = \sigma T$ for some $\sigma \in R(T)$.
