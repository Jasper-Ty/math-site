...
Our next basis will be the \defstyle{elementary symmetric functions}, which we will refer to as the \defstyle{elementaries} or the $e$'s.
...
\begin{definition}
    Let $\lambda \in \Par$. The \defstyle{Schur function} $s_\lambda$ is defined to be
    \[
        s_\lambda(\bfx)
        \coloneq
...
Where $\SSYT$ is the set of all \defstyle{semistandard Young tableaux}.
