...
A sequence of functions being pointwise bounded has an important consequence

\begin{myboxed}
    \textsc{Every pointwise bounded sequence has a subsequence that converges pointwise on a countable set}
